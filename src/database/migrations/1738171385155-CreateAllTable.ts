...
export class CreateAllTable1738171385155 implements MigrationInterface {
  name = 'CreateAllTable1738171385155';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "rss_item" ("pubDate" TIMESTAMP, "data" json NOT NULL, "content" character varying, "title" character varying, "url" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "rssOriginId" uuid NOT NULL, CONSTRAINT "PK_09289f2d16c1560380e085feb20" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "rss_item" ADD CONSTRAINT "FK_e3af98ee40c23c1cef4159043bf" FOREIGN KEY ("rssOriginId") REFERENCES "rss_origin"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
